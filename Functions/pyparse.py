...
def parse_ua(x):
    ...
    for i in range(obj_length):
        ...
        output_list[i] = {'device': UA_results['device']['family'],'os': UA_results['os']['family'], 'browser': UA_results['user_agent']['family'], 'browser_version': UA_results['user_agent']['major'], 'browser_minor': UA_results['user_agent']['minor']}    
...
#Write it
file = open('user_agent_output.json', 'w')
